...
picture = "/home/lunarplums/.config/rofi/assets/launcherbg.png"
...
process_rofi = subprocess.Popen(['/home/lunarplums/.config/rofi/scripts/launcheroptions.sh'])

# Edit this to sync feh and rofi better
#time.sleep(0.00)

# Edit the '576x324+672+378' to fit your rofi
process_sxiv = subprocess.Popen(["sxiv", '-b', '-g', '576x324+672+498', '-N', 'rofi-launcher-bg-0', picture])
